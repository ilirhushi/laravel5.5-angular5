...
var routes = [
    ...
    { path: 'dashboard', component: __WEBPACK_IMPORTED_MODULE_2__pages_dashboard_dashboard_component__["a" /* DashboardComponent */], pathMatch: 'full' }
];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_add_operator_exhaustMap__ = __webpack_require__("../../../../rxjs/_esm5/add/operator/exhaustMap.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_rxjs_add_operator_finally__ = __webpack_require__("../../../../rxjs/_esm5/add/operator/finally.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__pages_dashboard_dashboard_component__ = __webpack_require__("../../../../../src/app/pages/dashboard/dashboard.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_14__pages_dashboard_dashboard_component__["a" /* DashboardComponent */]
            ],
            imports: [
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_12__angular_common_http__["a" /* HttpClient */], __WEBPACK_IMPORTED_MODULE_13__services_api_service__["a" /* ApiService */]],
...
module.exports = "<p>\n  dashboard works!\n</p>\n<ul>\n  <li>\n    <h2><a routerLink=\"/\">Dashboard</a></h2>\n  </li>\n</ul>\n"
...
var ApiService = /** @class */ (function () {
    function ApiService(http, router) {
        this.http = http;
        this.router = router;
        this.api_url = __WEBPACK_IMPORTED_MODULE_5__environments_environment__["a" /* environment */].api_url;
    }
    ApiService.prototype.setHeaders = function () {
        ...
        return new __WEBPACK_IMPORTED_MODULE_6__angular_common_http__["c" /* HttpHeaders */](headersConfig);
    };
    ApiService.prototype.formatErrors = function (resp) {
        return __WEBPACK_IMPORTED_MODULE_4_rxjs_Observable__["a" /* Observable */].throw((undefined !== resp.error) ? resp.error : 'Error 500!');
    };
    /**
    ...
    ApiService.prototype.get = function (path, params) {
        if (params === void 0) { params = new __WEBPACK_IMPORTED_MODULE_6__angular_common_http__["d" /* HttpParams */](); }
    ...
    ApiService.prototype.put = function (path, body) {
        if (body === void 0) { body = {}; }
        return this.http.put("" + this.api_url + path, JSON.stringify(body), { headers: this.setHeaders() })
            .catch(this.formatErrors);
    };
    /**
